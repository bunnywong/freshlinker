...
get_header();
	...
	while( have_posts() ){
		...
		//echo $authorid.'shaya'.get_current_user_id();
		/**
				...
				<div class="experience-container">
					...
					<?php
						...
						?>
							...
							<span class="education-grade"><i class="fa fa-usd fa-fw"></i>&nbsp;<?php _e( 'Yearly Salary', 'jobboard' ); ?>&nbsp;:&nbsp;<?php echo esc_attr( $exp['sallary'] ); ?></span><br />
