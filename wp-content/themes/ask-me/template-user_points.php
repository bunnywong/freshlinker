						...
						<article class="question user-question user-points">
							<div class="question-content">
								<div class="question-bottom">
									...
									<?php }
										if ($point_result[0][4] != "rating_question" && $point_result[0][4] != "rating_answer" && $point_result[0][4] != "user_unfollow" && $point_result[0][4] != "user_follow" && $point_result[0][4] != "bump_question" && $point_result[0][4] != "select_best_answer" && $point_result[0][4] != "cancel_best_answer" && $point_result[0][4] != "answer_question" && $point_result[0][4] != "add_question" && $point_result[0][4] != "gift_site" && $point_result[0][4] != "admin_add_points" && $point_result[0][4] != "admin_remove_points") {
