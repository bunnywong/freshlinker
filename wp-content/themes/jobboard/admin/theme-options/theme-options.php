    	...
    	array(
    		...
    		'controls'	=> array(
              ...
              array(
    						...
    						'validation'=> 'numeric',
                'description'	=> __( 'If this is left blank, featuring a job will be free.', 'jobboard' ),
              ...
              array(
    						...
    						'description'	=> __( 'Activate to enable job package.', 'jobboard' ),
    					),
              ...
              array(
    						...
    						'description'	=> __( 'Activate to enable resume package.', 'jobboard' ),
    					),
