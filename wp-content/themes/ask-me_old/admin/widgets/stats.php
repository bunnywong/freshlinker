...
class Widget_Stats extends WP_Widget {
	...
	function Widget_Stats() {
		...
		$this->WP_Widget( 'stats-widget','Ask me - Stats', $widget_ops, $control_ops );
	}
		...
		echo $before_widget;
			...
			<div class="widget_stats ul_list ul_list-icon-ok">
				<ul>
					...
					<li><i class="icon-comment"></i><?php _e("Answers","vbegy")?> ( <span><?php echo get_all_comments_of_post_type("question")?></span> )</li>
					<li><i class="icon-user"></i><?php _e("Users","vbegy")?> ( <span><?php echo count($users)?></span> )</li>
				</ul>
			</div>
			<?php
		echo $after_widget;
