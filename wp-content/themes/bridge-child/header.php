			...
			<div class="vertical_menu_area_inner">
				...
				<div class="vertical_logo_wrapper">
					...
					<div class="q_logo_vertical">
						<a href="http://www.freshlinker.com/">
			...
			<?php } ?>
					...
					<div class="right">
                        ...
                        <div class="jobboard-login-register clearfix">
                            ...
                            ?>
                                <a class="btn btn-header-register" href="http://www.freshlinker.com/register"><?php _e( 'REGISTER', 'jobboard' ); ?></a>
                                <a class="btn btn-header-login" href="<?php echo wp_login_url( 'http://www.freshlinker.com' ); ?>"><?php _e( 'LOG IN', 'jobboard' ); ?></a>
                            <?php
                                }
                            ?>
                            </div>
                ...
                <?php } ?>
					<div class="header_inner_left">
						...
						<div class="logo_wrapper">
                            ...
                            <div class="q_logo_hidden"><a href="http://www.freshlinker.com/"><img alt="Logo" src="<?php echo $logo_image_fixed_hidden; ?>" style="height: 100%;"></a></div>
                            <?php } ?>
						</div>
					...
					<?php } ?>
						<div class="header_inner_center">
							<div class="logo_wrapper" style="height: <?php echo $logo_height/2; ?>px;">
								...
								?>
								<div class="q_logo">
									<a style="height: <?php echo $logo_height/2; ?>px;" href="http://www.freshlinker.com/">
										<img class="normal" src="<?php echo $logo_image; ?>" alt="Logo"/>
										<img class="light" src="<?php echo $logo_image_light; ?>" alt="Logo"/>
										<img class="dark" src="<?php echo $logo_image_dark; ?>" alt="Logo"/>
										<img class="mobile" src="<?php echo $logo_image_mobile; ?>" alt="Logo"/>
