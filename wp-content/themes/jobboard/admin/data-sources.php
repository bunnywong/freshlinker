...
if( !function_exists( 'jobboard_get_account_settings_page' ) ){

  function jobboard_get_account_settings_page(){
    $page_list = array();
    $pages = get_posts( array(
      'post_type'		=> 'page',
      'meta_query'	=> array(
        array(
          'key'	=> '_wp_page_template',
          'value'	=> 'page-templates/template-user-settings.php',
        ),
      ),
    ) );
  ...
  VP_Security::instance()->whitelist_function('jobboard_get_account_settings_page');
