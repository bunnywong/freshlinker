jQuery(document).ready(function($) {
	...
	jQuery(".ask-me .publish-question,.publish-question.publish-question-widget").click(function () {
	...
	jQuery(".following_not").live("click",function () {
		...
		jQuery.ajax({
			...
			success:function(data) {
				...
				following_not.addClass("following_you").removeClass("following_not").text("Follow").show();
				//location.reload();
			}
		});
		return false;
	...
	jQuery(".following_you").live("click",function () {
		...
		jQuery.ajax({
			...
			success:function(data) {
				jQuery(".followers span span").text(data);
				following_you.addClass("following_not").removeClass("following_you").text("Unfollow").show();
				//location.reload();
			}
		});
		return false;
