						        ...
						        <div class="comment-text">
						            <div class="author clearfix">
						            	<div class="comment-meta">
						    	        	<div class="comment-author"><a href="<?php echo vpanel_get_user_url($comment->user_id,get_the_author_meta('user_nicename', $comment->user_id));?>"><?php echo get_comment_author();?></a></div>
