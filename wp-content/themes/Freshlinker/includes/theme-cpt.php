...
/*------------------------------------------------------------*/
/*	Register "Resume Career Level" Taxonomy	*/
/*------------------------------------------------------------*/
if ( ! function_exists( 'jobboard_register_resume_career_level' ) ) {

	// Register Custom Taxonomy
	function jobboard_register_resume_career_level() {

		$labels = array(
			'name'                       => _x( 'Career Level', 'Taxonomy General Name', 'jobboard' ),
			'singular_name'              => _x( 'Career Level', 'Taxonomy Singular Name', 'jobboard' ),
			'menu_name'                  => __( 'Career Levels', 'jobboard' ),
			'all_items'                  => __( 'All Career Levels', 'jobboard' ),
			'parent_item'                => __( 'Parent Career Level', 'jobboard' ),
			'parent_item_colon'          => __( 'Parent Career Level:', 'jobboard' ),
			'new_item_name'              => __( 'New Career Level', 'jobboard' ),
			'add_new_item'               => __( 'Add New Career Level', 'jobboard' ),
			'edit_item'                  => __( 'Edit Career Level', 'jobboard' ),
			'update_item'                => __( 'Update Career Level', 'jobboard' ),
			'separate_items_with_commas' => __( 'Separate categories with commas', 'jobboard' ),
			'search_items'               => __( 'Search Career Level', 'jobboard' ),
			'add_or_remove_items'        => __( 'Add or remove career level', 'jobboard' ),
			'choose_from_most_used'      => __( 'Choose from the most used career level', 'jobboard' ),
			'not_found'                  => __( 'Not Found', 'jobboard' ),
		);
		$args = array(
			'labels'                     => $labels,
		...
		register_taxonomy( 'career_level', array( 'resume' ), $args );

	}


// Hook into the 'init' action
add_action( 'init', 'jobboard_register_resume_career_level', 0 );
