...
<div id="page-title-wrapper" class="company-account-setting">
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-12">
				...
				<div class="alert alert-danger">
					...
					<p><?php echo __('Your resume subscription package exceeded.', 'jobboard'); ?></p>
		...
		<?php if( jobboard_package_is_enabled('_package_resume') || jobboard_package_is_enabled('_package_resume_view') ) : ?>
		...
		<?php
			...
			/*	if( get_option('permalink_structure') == '/%postname%/' ) {
				...
				<div class="company-list-edit">
					...
					<a class="hidden-sm" href="<?php echo esc_url( jobboard_get_permalink('post_company').$end_permalink.'action=edit&jid='.$com_id ); ?>"><?php _e( 'Edit', 'jobboard' ); ?></a>
					<a class="visible-sm-inline" href="<?php echo esc_url( jobboard_get_permalink('post_company').$end_permalink.'action=edit&jid='.$com_id ); ?>"><i class="fa fa-edit"></i></a>
			...
			<div id="list-item-<?php echo $job_id; ?>" class="job-list-item clearfix">
				...
				<div class="job-list-featured">
					<?php
						...
						if( jobboard_option( 'cost_per_feature' ) == '' ) {
					...
					<form class="paypal_approval_payment_feature_job" name="paypal_approval" action="<?php echo esc_url($action); ?>" method="POST" class="payment-button">
						...
						<input type="hidden" name="return" value="<?php echo esc_url( $return_url ); ?>" />
						<input type="hidden" name="notify_url" value="<?php echo esc_url( $listener_url ); ?>" />
						<button type="submit" name="paynow" class="btn btn-paypal"><i class="fa fa-star"></i><?php _e( ' Mark As Featured', 'jobboard' ); ?></button>
					</form>
			...
			<div id="list-item-<?php echo get_the_id(); ?>" class="job-list-item clearfix">
				<div class="application-list-title">
					<div class="applicant-list-title-wrapper">
						<h4>
						<a href="<?php echo esc_url( get_permalink(get_post_meta( get_the_id(), '_jboard_applicant_resume', true )) ); ?>">
						<?php
