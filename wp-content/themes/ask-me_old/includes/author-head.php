	...
	<div class="user-profile">
		<div class="col-md-12">
			<div class="page-content">
				<h2><?php _e("About","vbegy")?> <a href="<?php echo vpanel_get_user_url($user_login->ID);?>"><?php echo $user_login->display_name?></a></h2>
				...
				<div class="ul_list ul_list-icon-ok about-user">
					<?php $user_registered = vpanel_options("user_registered");
