	...
	<div class="container">
		...
		<div class="jobs-listing-wrapper">
			<div id="job-listing-tabs" class="ghgfh">
				...
				?>
				<div id="<?php echo $job_type['slug'].'-'.$job_type['term_id']; ?>" class="sads">
				<?php
