		...
		?>
			...
			?>
				<div class="dropdown-menu clearfix" role="menu">
					<ul>
						<li>
							<a href="<?php echo esc_url( jobboard_get_permalink( 'dashboard' ) ); ?>"><?php _e( 'My profile', 'jobboard' ); ?></a>
						</li>
						<li>
							<a href="<?php echo esc_url( jobboard_get_permalink( 'profile' ) );  ?>"><?php _e( 'Account settings', 'jobboard' ); ?></a>
						</li>
						<li>
						<a href="<?php echo esc_url( wp_logout_url ( esc_url(home_url() )) ); ?>"><?php _e( 'Log Out', 'jobboard' ); ?></a>									
						</li>
					</ul>
