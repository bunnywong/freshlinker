	...
	<article <?php post_class('post  clearfix '.($blog_style == "blog_2"?"blog_2":"").(is_sticky()?" sticky_post":""));?> role="article" itemscope="" itemtype="http://schema.org/Article">
		<div class="post-inner">
			<?php if ($blog_style != "blog_2") {?>
				<div class="post-img<?php if ($vbegy_what_post == "video") {echo " video_embed";}else if ($vbegy_what_post == "google") {echo " map_embed";}else if (($vbegy_what_post == "image" && !has_post_thumbnail()) || !has_post_thumbnail()) {echo " post-img-0";}if ($vbegy_sidebar == "full") {echo " post-img-12";}else {echo " post-img-9";}?>">
	        ...
	        if ($blog_style == "blog_2") {?>
    	        <div class="post-img<?php if ($vbegy_what_post == "image" && !has_post_thumbnail()) {echo " post-img-0";}else if ($vbegy_what_post == "video") {echo " video_embed";}else if ($vbegy_what_post == "google") {echo " map_embed";}if ($vbegy_sidebar == "full") {echo " post-img-12";}else {echo " post-img-9";}?>">
    	        	<?php if (has_post_thumbnail() && $vbegy_what_post == "image") {?><a href="<?php the_permalink();?>" title="<?php printf('%s', the_title_attribute('echo=0')); ?>" rel="bookmark"><?php }
    	        		include (get_template_directory() . '/includes/head.php');?>
    	        	<?php if (has_post_thumbnail()) {?></a><?php }?>
    	        </div>
	        ...
	        if ($posts_meta == 1) {?>
	        	<div class="post-meta">
	        	    ...
	        	    <span class="meta-date" datetime="<?php the_time('c'); ?>" itemprop="datePublished"><i class="icon-time"></i><?php the_time($date_format);?></span>
	        	    <?php if (!is_page()) {?>
