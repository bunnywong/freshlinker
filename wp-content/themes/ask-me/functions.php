...
function vbegy_scripts_styles() {
	...
	if (is_category() && $cat_layout != "default") {
		...
		if ($products_layout != "full") {
			...
			if ($products_full_screen_background == 1 && $products_background_type != "patterns") {
				$custom_css .= '.background-cover {';
				...
				if ($products_background_type == "patterns" || !empty($custom_background)) {
					$custom_css .= 'body {
						...
						if (!empty($custom_background)) {
							if ($products_full_screen_background != 1) {
		...
		if ($questions_layout != "full") {
			...
			if ($questions_full_screen_background == 1 && $questions_background_type != "patterns") {
				$custom_css .= '.background-cover {';
				...
				if ($questions_background_type == "patterns" || !empty($custom_background)) {
					$custom_css .= 'body {
						...
						if (!empty($custom_background)) {
							if ($questions_full_screen_background != 1) {
								$custom_css .= esc_attr($custom_background["color"]).' url('.esc_attr($custom_background["image"]).') '.esc_attr($custom_background["repeat"]).' '.esc_attr($custom_background["position"]).' '.esc_attr($custom_background["attachment"]).';';
							}
						}
					$custom_css .= '}';
...
$default_options = array(
	...
	"loader" => 1,
	"nicescroll" => 1,
	"email_template" => get_bloginfo("admin_email"),
	"seo_active" => 1,
	"login_panel" => 1,
	...
	"index_top_box_background" => "background",
	...
	"send_email_question_groups" => array("editor" => 1,"administrator" => 1,"author" => 1,"contributor" => 1,"subscriber" => 1),
	"poll_user_only" => 0,
	"custom_permission" => 0,
	"ask_question" => 1,
	"show_question" => 1,
	...
	"show_answer" => 1,
	"add_post" => 1,
	"default_group" => "subscriber",
	"confirm_email" => 0,
	"site_users_only" => 0,
	"send_default_message" => 0,
	"the_captcha" => 0,
	"the_captcha_register" => 0,
	"the_captcha_post" => 0,
	"the_captcha_answer" => 0,
	...
	"names_register" => 0,
	"names_required" => 0,
	"terms_avtive_register" => 0,
	"terms_avtive_target_register" => "new_page",
	...
	"point_add_question" => 0,
	"point_best_answer" => 5,
	"point_add_comment" => 2,
	"point_rating_question" => 0,
	...
	"author_skin" => "default",
	"questions_custom_header" => 0,
	"questions_sidebar_layout" => "default",
	"questions_sidebar" => "default",
	"questions_layout" => "default",
	"questions_template" => "default",
	"questions_skin_l" => "default",
	"questions_skin" => "default",
	"products_custom_header" => 0,
	"products_sidebar_layout" => "default",
	"products_sidebar" => "default",
	"products_layout" => "default",
	"products_template" => "default",
	"products_skin_l" => "default",
	"products_skin" => "default",
	"home_display" => "blog_1",
	"date_format" => "F j , Y",
	"post_meta" => 1,
	"post_share" => 1,
	...
	"footer_copyrights" => "Copyright 2015 Ask me | <a href=#>By 2code</a>",
	"social_icon_h" => 1,
	"social_icon_f" => 1,
	"twitter_icon_f" => "#",
	"facebook_icon_f" => "#",
