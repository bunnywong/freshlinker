	...
	public function wp_pro_ad_api_load_adzone()
	{
		...
		if( isset( $_GET['wpproadszoneid'] ) && !empty( $_GET['wpproadszoneid'] ) )
		{
			if( method_exists( $pro_ads_adzones, 'display_adzone' ) )
			{
                ...
                <html>
                <head>
                <!-- Ads on this site are served by WP PRO Advertising System - All In One Ad Manager <?php echo WP_ADS_VERSION; ?> - http://bit.ly/WPPROADSYSTEM -->
                ...
                <body>
					...
					<?php
                    $arr = $pro_ads_adzones->get_adzone_data($_GET['wpproadszoneid'], array('id' => $_GET['wpproadszoneid']));
                    
                    if( $pro_ads_codex->wpproads_adzone_is_grid( $_GET['wpproadszoneid'] )  )
                    {
                        echo $pro_ads_adzones->display_adzone_grid( $_GET['wpproadszoneid'], $arr['atts'] );
                    }
                    else
                    {
                        echo $pro_ads_adzones->display_adzone( $_GET['wpproadszoneid'], $arr['atts'], $ref_url );
                    }
                    ?>
                </body>
                </html>
