		...
		<?php
			...
			if( isset( $_GET['action'] ) && $_GET['action'] == 'edit' ){
				...
				$input_value = array(
					...
					'year_experience' => vp_metabox( 'jobboard_resume_mb.year_experience', null, $resume_id ),
					'proposed_monthly_sallary' => vp_metabox( 'jobboard_resume_mb.proposed_monthly_sallary', null, $resume_id )
			);
			...
			<div class="col-md-8">
				<form method="post" class="frontend-form" action="" id="post-resume" role="form" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<input class="form-control" required="required" type="text" name="job_title" id="job_title" value="<?php echo esc_attr( $default['resume_job_title'] ); ?>" />
					</div><!-- /.form-group -->

					<div class="form-group">
						<label for="name"><?php _e( 'Location', 'jobboard' ); ?></label>
						<input class="form-control" required="required" type="text" name="location" id="location" value="<?php echo $default['resume_location']; ?>" />
					</div><!-- /.form-group -->
					...
					<div class="form-group">
						<label for="content"><?php _e( 'Cover Letter', 'jobboard' ); ?></label>
					...
					<div class="form-group">
						<label for="year_experience"><?php _e( 'Year Experience (<i>number value</i>)', 'jobboard' ); ?></label>
						<input class="form-control" required="required" type="text" name="year_experience" id="year_experience" placeholder="<?php _e( 'Example: 5', 'jobboard' ); ?>" value="<?php echo esc_attr( $default['year_experience'] ); ?>" />
					</div><!-- /.forn-group -->

					<div class="form-group">
						<label for="proposed_monthly_sallary"><?php _e( 'Proposed monthly sallary', 'jobboard' ); ?></label>
						<input class="form-control" required="required" type="text" name="proposed_monthly_sallary" id="proposed_monthly_sallary" value="<?php echo esc_attr( $default['proposed_monthly_sallary'] ); ?>" />
					</div><!-- /.forn-group -->
							...
							?>
								<div class="repeated-form" style="display:block">
									...
									<div class="row">
										...
										<div class="form-group col-md-6">
											<label for="experience_sallary"><?php _e( 'Yearly Salary', 'jobboard' ); ?></label>
