				...
				if (!is_404() && $site_users_only != "yes") {
					...
					?>
					<aside class="<?php echo (isset($sidebar_width) && $sidebar_width != ""?$sidebar_width:"col-md-3")?> sidebar<?php echo esc_attr($sticky_sidebar);?>">
						<?php get_sidebar();?>
					</aside><!-- End sidebar -->
				<?php }?>
				<div class="clearfix"></div>
...
<a href="http://www.freshlinker.com/tc/">Terms &amp; Conditions</a> | <a href=" http://www.freshlinker.com/privacy-policy/"> Privacy Statement </a> | <a href=" http://www.freshlinker.com/faq/"> FAQ </a>
</div>
