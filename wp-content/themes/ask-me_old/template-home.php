...
get_header();
	...
	if ($vbegy_index_tabs == 1) {
		...
		<div class="amads-widget-nf" style="text-align:center;">
		<?php echo do_shortcode("[pro_ad_display_adzone id=3822]"); ?>
        </div>    
		<!-- End page-content -->
