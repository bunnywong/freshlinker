				...
				<div id="search-text-input" class="row">
					<div class="col-md-7">
						<div class="form-group has-feedback">
							...
							<input class="form-control" type="text" name="keyword"  id="keyword" placeholder="<?php echo esc_attr( jobboard_option( 'keyword_placeholder' ) ); ?>" />
							<span class="fa fa-search form-control-feedback"></span>
						</div>
					</div>
					<div class="col-md-5">
						<div class="form-group job-filter-dropdown">
							<select id="job-nature-dropdown" class="form-control" name="job_nature" id="job_nature">
								<?php 
									echo '<option value="" class="select-label">'.__( 'All Job Nature', 'jobboard' ).'</option>';
									$terms = get_terms( 'job_nature' );
							...
							<script>
								jQuery(document).ready(function($){
									"use strict";
									$('#job-nature-dropdown').minimalect({
										placeholder : '<?php _e( "Select Job Nature", "jobboard" ); ?>'
									});
								});
