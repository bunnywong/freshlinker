                                                ...
                                                <tbody>
                                                    ...
                                                    <tr valign="top">
                                                        ...
                                                        <td>
                                                            ...
                                                            <br /><br />
                                                            <div>
                                                            	<input id="banner_is_html5_btn" name="banner_is_html5" type="checkbox" <?php echo ${'banner_is_html5'.$device_size['prefix']} ? 'checked="checked"' : ''; ?> /> <strong><?php _e('Banner is HTML5?', 'wpproads'); ?></strong>
                                                        ...
                                                        <td>
                                                            <select name="adzone_size<?php echo $device_size['prefix']; ?>" id="size_list<?php echo $device_size['prefix']; ?>">
                                                                ...
                                                                <option value="responsive" <?php echo !empty(${'responsive'.$device_size['prefix']}) ? 'selected="selected"' : ''; ?>>
                                                                    <?php _e('Full Width - <small>(Only recommended for background ads)</small>', 'wpproads'); ?>
                                                                </option>
                                                            </select>
