jQuery(document).ready( function($) {
	...
	if (jQuery("#vbegy_index_tabs").val() == 1) {
		jQuery("label[for='vbegy_what_tab'],label[for='vbegy_pagination_tabs'],label[for='vbegy_posts_per_page']").parent().parent().slideDown(500);
	}else if (jQuery("#vbegy_index_tabs").val() == 2) {
		jQuery("label[for='vbegy_posts_per_page']").parent().parent().slideDown(500);
		jQuery("label[for='vbegy_what_tab'],label[for='vbegy_pagination_tabs']").parent().parent().slideUp(500);
	}else {
		jQuery("label[for='vbegy_what_tab'],label[for='vbegy_pagination_tabs'],label[for='vbegy_posts_per_page']").parent().parent().slideUp(500);
	}
